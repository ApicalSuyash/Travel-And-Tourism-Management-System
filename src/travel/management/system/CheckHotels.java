...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Radisson Blu Hotel");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            ...
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Shreemaya Hotel");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Solaris Hotel & Resort");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Imperial Grand Hotel");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Prsident Hotel");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Anjushree Inn");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Aashray Hotel");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("Taj Lakefront Hotel");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("Pride Hotel");
            l11.add(caption);
            Thread.sleep(2800);
